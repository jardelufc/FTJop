...
//			System.err.println("arguments: [-cp classpath] [-o file] class [class]*");
	...
	public void load() throws IOException {
		...
		for (int nr=0; i.hasNext(); ++nr) {
			...
			System.out.println("Load class: " + jcl[nr].getClassName());
		}
	...
	private void printClassNames(TransitiveHull hull) {
		String[] classNames = hull.getClassNames();
		for (String clazz : classNames) {
			System.out.println("Transitive Hull class: " + clazz);
		}
