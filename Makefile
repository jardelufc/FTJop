...
java_app:
	...
	javac $(TARGET_JFLAGS) -verbose $(TARGET)/src/common/com/jopdesign/sys/*.java
	javac $(TARGET_JFLAGS) -verbose $(TARGET)/src/jdk_base/java/lang/annotation/*.java	# oh new Java 1.5 world!
	javac $(TARGET_JFLAGS) -verbose $(TARGET_APP)
	cd $(TARGET)/dist/classes && jar cf ../lib/classes.zip *
	$(OPTIMIZE)
