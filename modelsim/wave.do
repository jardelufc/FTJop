...
add wave -noupdate -format Literal -radix decimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/bc_len
...
add wave -noupdate -divider {Hamming}
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/clk
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/rst
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/en_enc
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/en_dec
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/data
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/addr_rd
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/addr_wr
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/ham_out
add wave -noupdate -format Literal -radix binary /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_ham_top/decod/ham_out

add wave -noupdate -divider {CRC}
add wave -noupdate -format Literal -radix decimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/bc_len
add wave -noupdate -format Literal -radix decimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/len
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/CRC_out
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/data
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/Comp
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/D2
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/enable
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/flag
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/crc_bsy
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/Pass
add wave -noupdate -format logic /tb_jop/cmp_jop/cpm_cpu/cmp_mem/cmp_crc/Fail
