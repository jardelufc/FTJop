...
rem vcom %options% %jopdir%/scio/sc_ioparallel.vhd
...
rem HAMMING BLOCK
 ...
 vcom %options% %jopdir%/simulation/sim_hnc.vhd
rem vcom %options% %jopdir%/hamming/mem_sc_mod/mem_sc.vhd
 vcom %options% %jopdir%/hamming/hamming/top/ham_top.vhd
 vcom %options% %jopdir%/hamming/hamming/decoder/ham_decod.vhd
 vcom %options% %jopdir%/hamming/hamming/encoder/ham_enc.vhd

rem END HAMMING BLOCK

rem CRC BLOCK

 vcom %options% %jopdir%/crc/crc.vhd
